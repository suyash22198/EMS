...
class AppColors {
  ...
  static const Color primaryColor = Color.fromARGB(255, 189, 8, 53);
  static const Color secondaryColor = Color.fromARGB(255, 7, 2, 32);

  
  static const Color primaryColorLight = Color(0xffC62B16);
  ...
  static Color grey = Colors.grey.withOpacity(0.4);
